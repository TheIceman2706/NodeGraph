...
namespace NodeGraph.View
{
    public class NodePropertyPortViewsContainer : ItemsControl
    {
        ...
        protected override bool IsItemItsOwnContainerOverride(object item)
        {
            ...
            NodePropertyPortViewModelAttribute[] attrs = item.GetType().GetCustomAttributes(typeof(NodePropertyPortViewModelAttribute), false) as NodePropertyPortViewModelAttribute[];
