...
namespace NodeGraph.View
{
    public class ConnectorView : ContentControl
    {
        ...
        {
            get => (string)this.GetValue(CurveDataProperty);
            set => this.SetValue(CurveDataProperty, value);
        }
        ...
        {
            LayoutUpdated += this.ConnectorView_LayoutUpdated;
            DataContextChanged += this.ConnectorView_DataContextChanged;
            Loaded += this.ConnectorView_Loaded;
        }
        ...
        {
            this.ViewModel = this.DataContext as ConnectorViewModel;
        ...
        {
            FlowChart flowChart = this.ViewModel.Model.FlowChart;
            FlowChartView flowChartView = flowChart.ViewModel.View;
            this.BuildCurveData(Mouse.GetPosition(flowChartView));
        }
        ...
        {
            Connector connector = this.ViewModel.Model;
            ...
            this.CurveData = string.Format("M{0},{1} C{0},{1} {2},{3} {4},{5} " +
                "M{4},{5} C{4},{5} {6},{7} {8},{9}",
